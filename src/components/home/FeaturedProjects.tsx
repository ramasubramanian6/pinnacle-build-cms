      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-16">
          ...
          >
            <Link
              to="/projects"
              className="group inline-flex items-center gap-2 text-foreground font-medium hover:text-accent transition-colors mt-6 md:mt-0"
            >
              ...
              <Link to={`/projects/${project.id}`} className="group block">
                <div className="relative h-[280px] rounded-lg overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <h3 className="font-display text-2xl font-bold text-foreground mb-2 group-hover:text-accent transition-colors duration-300">
                      {project.title}
                    </h3>
                    <div className="flex items-center gap-2 text-muted-foreground">
                      <MapPin size={14} />
