  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium font-body ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-accent text-accent-foreground hover:bg-gold-dark shadow-gold font-semibold",
        "gold-outline": "border-2 border-accent text-accent hover:bg-accent hover:text-accent-foreground font-semibold",
        hero: "bg-accent text-accent-foreground hover:bg-gold-dark shadow-gold uppercase tracking-wider font-semibold",
        "hero-outline": "border-2 border-foreground/30 text-foreground hover:bg-foreground/10 uppercase tracking-wider font-semibold",
      },
      size: {
